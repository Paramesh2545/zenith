...
export const LeafIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c1.353 0 2.665-.213 3.896-.621M12 3c1.353 0 2.665.213 3.896.621m-3.896-.621a9.004 9.004 0 01-8.716 6.747M12 3a9.004 9.004 0 008.716 6.747m-17.432 0A4.5 4.5 0 015.25 6.255" />
  </svg>
);